*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_LOGALI
*   generation date: 08.06.2022 at 09:51:09
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_LOGALI          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_LOGALI'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_LOGALI_EXTRACT
TOTAL = ZMV_LOGALI_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_LOGALI'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_LOGALI-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_LOGALI_EXTRACT
TOTAL = ZMV_LOGALI_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_LOGALI-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_LOGALI'
...
TOTAL = ZMV_LOGALI_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_LOGALI-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_LOGALI-UPD_FLAG NE SPACE.
